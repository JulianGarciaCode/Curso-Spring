...
public class Employee {
    ...
    //Lo idóneo sería usar un constructor Builder o librería tipo LoomBok, para tener un código limpio y mantener buenas prácticas
    public Employee(Long id, String name, int age, Boolean married, Double salary, Instant createdDate, LocalDate birthDate, LocalDateTime registrationDate, List<String> email, EmployeeType category, Address address, Company company, List<Project> projects) {
        this.id = id;
        this.name = name;
        this.age = age;
