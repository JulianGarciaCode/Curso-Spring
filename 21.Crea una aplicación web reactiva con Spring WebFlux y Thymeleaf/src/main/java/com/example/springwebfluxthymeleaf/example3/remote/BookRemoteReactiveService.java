package com.example.springwebfluxthymeleaf.example3.remote;

import com.example.springwebfluxthymeleaf.example3.model.Book;
...
public class BookRemoteReactiveService {
    ...
    //Igual que el BookRemoteService pero con Flux en lugar de List
    //Tiene menor tiempo de carga de esta forma
